...
gPats = [
  ...
  [r'(.*)(encender|encienda|prender|prenda)(.*)(luz|bombillas|bombillo|lampara|lamparas|luces)(.*)baño(.*)',
  [ 
    data.controlLuzBano, data.object[18], 1
    ]], 
 
  [r'(.*)(apagar|apague)(.*)(luz|bombillas|bombillo|lampara|lamparas|luces)(.*)baño(.*)',
  [ 
    data.controlLuzBano, data.object[18], 0
    ]],

  [r'(.*)estado(.*)(luz|bombillas|bombillo|lampara|lamparas|luces)(.*)baño(.*)',
  [ 
